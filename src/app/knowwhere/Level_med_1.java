...
public class Level_med_1 extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		info5="Image of Galešnjak (Island of Love)!!"+"\n"+"It is located in the Pašman channel of the Adriatic, between the islands of Pašman and the town of Turanj on mainland Croatia.";
