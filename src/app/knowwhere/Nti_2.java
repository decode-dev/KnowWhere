...
public class Nti_2 extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		String info2="Hurricane Isaac made landfall in Louisiana on August 28, 2012, and moved very slowly north."+"\n"+"If we look at the picture, we can see that the dark tones show saturated land and the lighter blue tones of the two lakes represent turbid water and sediment flow.";
